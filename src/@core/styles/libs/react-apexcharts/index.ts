...
const ApexChartWrapper = styled('div')(({ theme }) => ({
  '& .apexcharts-canvas': {
    ...
    '& .apexcharts-xaxistooltip': {
      borderColor: theme.palette.divider,
      background: theme.palette.mode === 'light' ? theme.palette.grey[50] : theme.palette.customColors.background1,
      '&:after': {
        borderBottomColor:
          theme.palette.mode === 'light' ? theme.palette.grey[50] : theme.palette.customColors.background1
      },
      '&:before': {
